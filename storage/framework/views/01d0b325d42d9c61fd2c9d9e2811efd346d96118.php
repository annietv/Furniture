            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-12  py-3">
                    ...
                    <select name="departments" class="form-control select2bs4">
                        ...
                        <option value="<?php echo e($row->depart_name); ?>"><?php echo e($row->depart_name); ?></option>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\furniture\resources\views/admin/products/product.blade.php ENDPATH**/ ?>