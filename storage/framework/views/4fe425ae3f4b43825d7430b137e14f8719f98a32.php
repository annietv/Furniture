                ...
                <div class=" table-responsive m-t-40 py-3">
                    <table id="example1" class="table  table-striped td-responsive norow">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo e($row->depart_name); ?></td>
                                <td><?php echo e($row->contents); ?></td>
                                <td><img src=" <?php echo e(asset('images/department/'.$row->image)); ?>" alt="" width="100px">
                                </td>
                                <td>

                                    <a href="<?php echo e(url('admin/products/editdepartment/'.$row->id)); ?>"><button type="button"
                                            class="btn btn-xs btn-primary"><i class="fa fa-wrench"></i></button></a>
                                    <a href="<?php echo e(url('admin/products/deletedepartment/'.$row->id)); ?>"><button type="button"
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\furniture\resources\views/admin/products/viewdepartment.blade.php ENDPATH**/ ?>