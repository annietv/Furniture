...
<section id="hero">
    ...
    ?>
            <?php $__currentLoopData = $site_sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item active"
                    style="background-image: url('<?php echo e(asset('images/slider/'.$key->proimage)); ?>');">
                    <div class="carousel-container">
                        <div class="carousel-content container">
                            <h2 class="animate__animated animate__fadeInDown col-lg-10"
                                style="color: #FFFFFF;  text-shadow: 3px 5px #000000;"><?php echo e($key->title); ?>

                            </h2>
                            <p class="animate__animated animate__fadeInUp"><?php echo $key->contents; ?></p>
...
</section><!-- End Hero --><?php /**PATH C:\xampp\htdocs\furniture\resources\views/home/slidercontent.blade.php ENDPATH**/ ?>