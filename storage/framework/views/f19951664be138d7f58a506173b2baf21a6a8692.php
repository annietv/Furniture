...
<?php $__env->startSection('subtitle', 'Update Department'); ?>
            ...
            <div class="col-lg-8">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-12 py-3">
                        ...
                        <input type="text" name="depart_name" class="form-control" value="<?php echo e($row->depart_name); ?>">
                    </div>
                    <div class="col-12 py-3">
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\furniture\resources\views/admin/products/editdepartment.blade.php ENDPATH**/ ?>