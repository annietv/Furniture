...
/*# sourceMappingURL=maps/style.css.map */
 ...
 <div class="preloader">
     <img src="<?php echo e(asset('images/o.gif')); ?>" alt="preloader">
 </div>
 <!-- preloader end -->
 ...
 <header class="fixed-top header">
    ...
    ?>
                     ...
                     <a class="text-white mr-3" href="callto:<?php echo e($row->phoneone); ?>"><strong>CALL</strong>
                         <?php echo e($row->phoneone); ?></a>
    ...
    ?>
                     ...
                     <ul class="list-inline d-inline">
                         <li class="list-inline-item mx-0"><a class="d-inline-block p-2 text-light"
                                 href="<?php echo e($row->facebook); ?>"><i cl#ass="ti-facebook"></i></a></li>
                         <li class="list-inline-item mx-0"><a class="d-inline-block p-2 text-light"
                                 href="<?php echo e($row->twitter); ?>"><i class="ti-twitter-alt"></i></a></li>
                         <li class="list-inline-item mx-0"><a class="d-inline-block p-2 text-light"
                                 href="<?php echo e($row->linkedin); ?>"><i class="ti-linkedin"></i></a></li>
                         <li class="list-inline-item mx-0"><a class="d-inline-block p-2 text"
                                 href="<?php echo e($row->instagram); ?>"><i class="ti-instagram"></i></a></li>
                     </ul>
                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                 </div>
                 <div class="col-lg-8 text-center text-lg-right">
                     <ul class="list-inline">
                         <li class="list-inline-item"><a
                                 ...
                                 href="<?php echo e(Route('Mainabout')); ?>">About</a>
                         </li>
                         <li class="list-inline-item"><a
                                 class="text-uppercase text-white p-sm-2 py-2 px-0 d-inline-block"
                                 href="<?php echo e(Route('contact_form')); ?>">Contact</a>
                         </li>
                         <li class="list-inline-item"><a
     ...
     </div><?php /**PATH C:\xampp\htdocs\furniture\resources\views/home/topnav.blade.php ENDPATH**/ ?>