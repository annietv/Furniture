            ...
            <div class="col-lg-8">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-12 py-3">
                        ...
                        <input type="text" name="fullname" class="form-control" value="<?php echo e($row->fullname); ?>">
                    </div>
                    <div class="col-12 py-3">
                        <label>Position </label>
                        <input type="text" name="positions" class="form-control" value="<?php echo e($row->positions); ?>">
                    </div>
                    <div class="col-12 py-3">
                        <label> Bio-Data </label>
                        <textarea name="contents" cols="30" rows="10" id="compose-textarea" class="form-control "
                            style="height: 500px"><?php echo e($row->contents); ?></textarea>
                    </div>
                    <div class="col-12 py-3">
                        <label> Status: </label>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\furniture\resources\views/admin/views/editteam.blade.php ENDPATH**/ ?>