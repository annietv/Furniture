        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12 col-sm-6">
                    <h3 class="d-inline-block d-sm-none">{{$row->product_name}}</h3>
                    <div class="col-12">
                        <img src="{{asset('images/products/'.$row->proimage)}}" class="product-image"
                            alt="Product Image" width="100%">
                    </div>

                </div>
                <div class="col-12 col-sm-6">
                    <h3 class="my-3">{{$row->product_name}}</h3>
                    ...
                    <div class="mt-4">
                        <a href="{{url('home/cashout/'.$row->id)}}" class=" btn btn-primary btn-lg btn-flat">
