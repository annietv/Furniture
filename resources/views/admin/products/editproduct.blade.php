        ...
        <div class="card-body bg-white rounded p-4">
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-12  py-3">
                    ...
                    <input type="number" name="initial_price" class="form-control" value="{{$row->initial_price}}">
                </div>
                <div class="col-12  py-3">
                    <label>Current Price</label>
                    <input type="number" name="current_price" class="form-control" value="{{$row->current_price}}">
                </div>
                <div class="col-12  py-3">
                    <label>Product Descriptions</label>
                    <textarea id="compose-textarea" cols="30" rows="10" class="form-control"
                        name="product_desc">{{$row->product_desc}}</textarea>
                </div>
                <div class="col-12 py-3">
